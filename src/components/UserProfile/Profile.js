      ...
      <View>
        ...
        <TouchableRipple onPress={() => navigation.navigate("SignUp")}>
          <View style={ProfileStyles.menuItem}>
            ...
            <Text style={ProfileStyles.menuItemText}>Add New Admin</Text>
          </View>
        </TouchableRipple>
        <TouchableRipple onPress={() => navigation.navigate("EmployeeCreation")}>
          <View style={ProfileStyles.menuItem}>
            <Icon name="account-check-outline" color="#000" size={25} />
            <Text style={ProfileStyles.menuItemText}>Add New Employee</Text>
          </View>
        </TouchableRipple>
      </View>
    </SafeAreaView>
